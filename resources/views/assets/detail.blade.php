            ...
            <div class="card-body py-4 px-4">
                <div class="h3 fw-bolder mt-4 text-uppercase">
                    <div class="col-md-12 form-group mb-3">
                        <label for="Asset Status" class="small fw-bolder text-uppercase">Asset ID :</label>
                        <span>ABC00{{ $assets->id }}</span><br>
                        <label for="Asset Status" class="small fw-bolder text-uppercase">Asset Name :</label>
